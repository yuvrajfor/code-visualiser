    ...
    <div className={`lab-shell visual-theme-${visualTheme} min-h-screen overflow-x-hidden text-[#f7f0e8]`}>
      ...
      {activeView === "landing" && (
        <main className={`lab-grid landing-mode-${landingWorkspace} mx-auto w-full max-w-7xl px-5 py-10 md:px-8 md:py-14`} data-learning-workspace={landingWorkspace}>
          ...
          <section data-detailed-workspaces className="mt-10 grid gap-6 lg:grid-cols-[minmax(0,1fr)_17rem]">
            <div className="lab-surface relative overflow-hidden rounded-[28px] p-5 md:p-8" data-code-story-input>
      ...
      {activeView === "studio" && currentStep && (
        <main className="lab-grid mx-auto w-full max-w-7xl px-5 py-7 md:px-8">
          <div className="lab-surface mb-5 flex flex-col justify-between gap-4 rounded-3xl p-5 md:flex-row md:items-center" data-code-story-workspace>
