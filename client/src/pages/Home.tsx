    ...
    <div className={`lab-shell visual-theme-${visualTheme} min-h-screen overflow-x-hidden text-[#f7f0e8]`} data-visual-theme={visualTheme}>
      ...
      {activeView === "studio" && currentStep && (
        <main className="lab-grid studio-learning-frame mx-auto w-full max-w-7xl px-5 py-7 md:px-8">
          ...
          <section className="execution-workspace-grid visual-first-workspace grid gap-6 lg:grid-cols-[1.12fr_.88fr]">
            ...
            <div className="lab-surface story-explanation-panel direct-explanation-panel rounded-[28px] p-5 md:p-6" data-direct-explanation-panel>
              <div className="flex items-center justify-between border-b border-white/10 pb-4"><div className="flex items-center gap-2"><Lightbulb className="h-4 w-4 text-indigo-200" /><div><p className="lab-kicker">AI explanation · read second</p><h2 className="mt-1 text-sm font-bold text-white">What the computer is doing</h2></div></div><Badge className="rounded-full border border-indigo-300/25 bg-indigo-300/10 px-3 py-1 text-[10px] font-bold text-indigo-100">Line {currentStep.line}</Badge></div>
